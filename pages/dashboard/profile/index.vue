  ...
  <div class="max-w-3xl mx-auto space-y-10 py-6 pb-24">
    ...
    <div v-if="user" class="space-y-10">
        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
          ...
          <div class="flex-1 space-y-2">
            ...
            <div class="flex flex-wrap justify-center md:justify-start items-center gap-3 pt-2">
              <span class="px-2.5 py-1 bg-white/10 text-white text-[10px] font-bold rounded-lg uppercase tracking-wider border border-white/10">{{ user.role }}</span>
              <div class="w-1 h-1 rounded-full bg-white/20"></div>
              <span class="text-[10px] font-semibold text-white/60 uppercase tracking-wider">{{ user.campus?.name || 'Global Campus' }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Account Settings -->
        <div class="space-y-4">
          <h3 class="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Identity & Financials</h3>
          <div class="space-y-3">
            <NuxtLink to="/dashboard/profile/edit" class="flex items-center gap-4 p-4 bg-white border border-gray-100 rounded-2xl hover:border-gray-300 transition-all group shadow-sm">
              ...
              <div class="flex-1">
                ...
                <p class="text-[10px] text-gray-400 font-medium">Update your details</p>
              </div>
            ...
            <NuxtLink to="/dashboard/profile/bank" class="flex items-center gap-4 p-4 bg-white border border-gray-100 rounded-2xl hover:border-gray-300 transition-all group shadow-sm">
              ...
              <div class="flex-1">
                ...
                <p class="text-[10px] text-gray-400 font-medium">Manage bank accounts</p>
              </div>
              <Icon name="ChevronRight" class="text-gray-300 group-hover:text-black transition-colors" size="18" />
            </NuxtLink>
          </div>
        ...
        <!-- Activity -->
        <div class="space-y-4">
          <h3 class="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Growth & History</h3>
          <div class="space-y-3">
            <NuxtLink to="/dashboard/referrals" class="flex items-center gap-4 p-4 bg-white border border-gray-100 rounded-2xl hover:border-gray-300 transition-all group shadow-sm">
              ...
              <div class="flex-1">
                ...
                <p class="text-[10px] text-gray-400 font-medium">Track your links</p>
              </div>
              <Icon name="ChevronRight" class="text-gray-300 group-hover:text-black transition-colors" size="18" />
            </NuxtLink>
            ...
            <NuxtLink to="/dashboard/withdrawals" class="flex items-center gap-4 p-4 bg-white border border-gray-100 rounded-2xl hover:border-gray-300 transition-all group shadow-sm">
              ...
              <div class="flex-1">
                ...
                <p class="text-[10px] text-gray-400 font-medium">Withdrawal history</p>
              </div>
              <Icon name="ChevronRight" class="text-gray-300 group-hover:text-black transition-colors" size="18" />
            </NuxtLink>
          </div>
      ...
      <div class="pt-8 flex flex-col items-center gap-6">
        <button 
          @click="handleLogout" 
          class="flex items-center gap-3 px-8 py-3 rounded-xl bg-red-50 text-red-600 font-bold text-xs uppercase tracking-wider hover:bg-red-100 transition-all group"
        >
          <Icon name="LogOut" size="18" class="group-hover:-translate-x-1 transition-transform" />
          Sign out account
        </button>
        <div class="text-center">
           <p class="text-[10px] font-bold text-gray-300 uppercase tracking-widest">CampusLink Ambassador</p>
